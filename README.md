...
[1-3]*, *save current settings as profile [1-3]*, *schedule a start [today |
tomorrow] at [time] with profile [1-3]* (time in the Homey's timezone),
*cancel the scheduled start*, *set the measured power*;
